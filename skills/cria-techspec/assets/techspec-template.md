...
export interface HttpInterface {
  http(config?: AxiosRequestConfig): Promise<AxiosInstance>;
}
```
...
[Se aplicável e Se necessário, descreva testes de E2E:
...
[Pesquisa as skills na pasta @.cursor/skills ou @.claude/skills que se encaixam e se apliquem nesta techspec e liste-as abaixo:]
